...
//   }
    ...
    return !item ? <p>item doesn't exist</p> : (
            ...
            <div class="container px-5 py-24 mx-auto">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <button class="flex ml-auto text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Like</button>
    ...
    <button class="flex ml-auto text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Leave Comment</button>
    <p class="leading-relaxed">{interaction[0].comment}</p>
    <button class="flex ml-auto text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Delete Comment</button>
